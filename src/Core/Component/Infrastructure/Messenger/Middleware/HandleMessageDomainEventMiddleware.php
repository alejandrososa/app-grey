...
class HandleMessageDomainEventMiddleware implements MiddlewareInterface
{
    ...
    public function handle(Envelope $envelope, StackInterface $stack): Envelope
    {
        ...
        $envelope = $this->handleEnvelop($envelope, $handlerDescriptors, false);
     ...
     */
    private function handleEnvelop(Envelope $envelope, iterable $handlers, bool $isDomainEvent): Envelope
    {
